                    ...
                    do {                          
                        ...
                        case '2' :
                          if (currentMember.borrowOne())
                           System.out.println("you have borrow one book succefley");
                          else 
                           System.out.println("you can't borrowed more than 5 book");
                          break;
                        case '3' :
                         if (currentMember.returnOne())
                          System.out.println("you have return one succsefly");
                         else 
                          System.out.println("you must have one book at least");
                         break;
                        case '4' :
